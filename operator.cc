...
Operator get_binary_operator_from_token(token::TokenType tok_type){
    switch(tok_type){
        case token::ADD: return Operator::ADD_OP;
        case token::SUB: return Operator::SUB_OP;
        case token::MULT: return Operator::MULT_OP;
        case token::DIV: return Operator::DIV_OP;
        case token::POW: return Operator::POW_OP;
...
Operator get_unary_operator_from_token(token::TokenType tok_type){
    switch(tok_type){
        case token::ADD: return Operator::POS_OP;
        case token::SUB: return Operator::NEG_OP;
    }
    return Operator::INVALID_OP;
